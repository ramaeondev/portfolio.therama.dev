        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2">
            <div className="space-y-4 text-muted-foreground">
              <p>
                Hello! I'm a passionate Angular developer with a strong foundation in frontend technologies and a knack for creating intuitive user experiences. With 5+ years of experience in web development, I've become adept at turning complex problems into elegant solutions.
              </p>
              <p>
                My journey in tech began at [University Name] where I earned my Bachelor's degree in Computer Science. Since then, I've worked with various companies ranging from startups to large enterprises, contributing to projects that have impacted thousands of users.
              </p>
              <p>
              ...
              <p>
                When I'm not in front of a computer, you'll find me hiking in nature, experimenting with photography, or enjoying a good book with a cup of coffee.
              </p>
            </div>
          </div>
